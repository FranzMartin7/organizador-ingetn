...
<div class="row my-1">
    ...
    <div class="col-12 col-sm-6">
        <div class="input-group mb-1">
            ...
            <select name='idActividad' id='idActividad' class="selectpicker form-control show-tick" aria-label="Small" aria-describedby="addonActividad" data-style="btn-verdeClaro">
                <option value="">Todos</option>
...
<script>
    $(document).ready(function(){
        ...
        var gestion = $('#gestion');
        var filtros = $('#idAsignatura,#idActividad,#idPeriodo,#gestion');
