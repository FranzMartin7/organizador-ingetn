...
<div class="row">
    <div class="col-12 col-sm-8 col-sm-9 mt-1">
...
<div class="row mt-1">
    ...
    <div class="col-12 col-sm-4">
        <div class="input-group mb-1">
            <div class="input-group-prepend">
                <label for="idAula" class="input-group-text bg-primario font-weight-normal" id="addonActividad">Ver aula</label>
            </div>
        ...
        <form action="">
            <div class="modal-body">
                ...
                <div class="form-row mb-2">
                    ...
                    <div class='col-sm-9'>
                        <textarea type="text" id="txtEnlace" rows="3" class="form-control" placeholder="Escribe el enlace"></textarea>
                    </div>                 
                </div>
            </div>
...
<script>
    $(document).ready(function(){
        ...
        var gestion = $('#gestion');
        var filtros = $('#idAsignatura,#idAula,#idPeriodo,#gestion,#idActividad');
